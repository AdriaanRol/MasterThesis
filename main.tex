...
% Clearly ending in several key requirements for the experiments:
        ...
        %  Parity measurements
\input{NV-Center_in_diamond.tex}
% Chapter elaborates on general electronic spin control and the architecture of a typical experiment
\input{Addressing_weakly_coupled_carbon_spins.tex} %split into subdocuments for the sections.
...
\input{Fingerprint_data_appendix.tex}
...
\input{learn_for_defence/useful_values.tex}

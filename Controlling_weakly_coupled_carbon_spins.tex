...
\Cref{fig:FP} shows the result of a fingerprint experiment on the sample studied in this thesis.
The broad collapse due to the spin bath is clearly visible at $\tau/(4 \tau _L)$ for odd m.
Besides some isolated peaks the most


% identify main features
% spin-bath
%strongly coupled spin 2
% Fitted with 13 spins using analytical formulas from supplements of tim's paper
% 4 promising spins

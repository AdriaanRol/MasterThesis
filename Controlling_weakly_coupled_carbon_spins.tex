...
The sequence can be extended to swap type initialization by implementing an additional $\mp{\mathrm{y}}$-gate\footnote{! In the circuits we use a Y-gate, need to check if I made a mistake here.}.

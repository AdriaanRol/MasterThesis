...
\begin{figure}[htbp]
    ...
    \caption{Placeholder for strong weak regimes figure. Figure contains NV- center with 2 concentric circles and spin symbols to designate domains. Has inset with DESR showing line split due to Nitrogen spin or Nitrogen and Carbon spin.}
    \label{fig:label}
\end{figure}
